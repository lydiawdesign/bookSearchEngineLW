...
Beginning with starter code with a fully functioning Google Books API search engine built with a RESTful API, I am tasked to refactor it to be a GraphQL API built with Apollo Server. Originally, the app was built using the MERN stack with a React front end, MongoDB database, and Node.js/Express.js server and API. It allows users to save book searches to the back end. 
...
<!-- * `auth.js`: Update the auth middleware function to work with the GraphQL API. x -->

<!-- * `server.js`: Implement the Apollo Server and apply it to the Express server as middleware. x -->
